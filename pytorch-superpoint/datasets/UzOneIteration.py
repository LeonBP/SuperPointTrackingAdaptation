...
class UzOneIteration(data.Dataset):
    default_config = {
        'labels': None,
    ...
    def __init__(self, export=False, transform=None, task='train', **config):
        ...
        # get files
        base_path = Path(DATA_PATH, 'BMVC2021/one_iteration/')# + task + '2014/')
    ...
    def __getitem__(self, index):
        ...
        def _read_image(path):
            ...
            input_image = cv2.cvtColor(input_image, cv2.COLOR_RGB2GRAY)#input_image[:,:,1]#

...
class SuperPoint_LG(nn.Module):
    ...
    def __init__(self, **conf):
        ...
        path = Path(__file__).parent / 'weights/superpoint_v1_lg.pth'
    ...
    def forward(self, data: dict) -> dict:
        ...
        # Extract keypoints
        best_kp = torch.where(scores > self.conf["keypoint_threshold"])
        ...
        return {
            ...
            "scores": torch.stack(scores, 0), # keypoint_
